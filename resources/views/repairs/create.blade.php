...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-slate-900 border border-slate-800 rounded-xl p-6">
        <form action="{{ route('repairs.store') }}" method="POST" class="space-y-8">
            @csrf
            ...
            <div class="flex justify-end gap-3 border-t border-slate-800 pt-4">
                <a href="{{ route('repairs.index') }}" class="px-4 py-2 bg-slate-850 hover:bg-slate-800 text-slate-300 font-bold rounded-lg text-xs transition-colors">
                    CANCEL
                </a>
