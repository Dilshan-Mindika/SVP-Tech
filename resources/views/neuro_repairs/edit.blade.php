...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3 pb-4 border-b border-slate-800">
        <a href="{{ route('neuro_repairs.show', $repair->id) }}" class="p-2 bg-slate-900 border border-slate-800 rounded-lg text-slate-400 hover:text-slate-200 transition-colors">
    ...
    <div class="bg-slate-900 border border-slate-800 rounded-xl p-6">
        <form action="{{ route('neuro_repairs.update', $repair->id) }}" method="POST" class="space-y-8">
            @csrf
            ...
            <div class="flex justify-end gap-3 border-t border-slate-800 pt-4">
                <a href="{{ route('neuro_repairs.show', $repair->id) }}" class="px-4 py-2 bg-slate-850 hover:bg-slate-800 text-slate-300 font-bold rounded-lg text-xs transition-colors">
                    CANCEL
                </a>
