            ...
            @if($invoices->isNotEmpty())
                <div class="bg-slate-900 border border-slate-800 rounded-xl p-5 space-y-4">
                    <div class="flex items-center justify-between border-b border-slate-800 pb-3">
                        ...
                        <a href="{{ route('neuro_invoices.index') }}" class="text-xs text-cyan-400 hover:text-cyan-300 font-semibold uppercase tracking-wider">View All</a>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-collapse text-sm">
                            <thead>
                            ...
                            <tbody class="divide-y divide-slate-800/40">
                                @foreach($invoices as $invoice)
                                    <tr class="hover:bg-slate-800/30 transition-colors">
                                        <td class="py-3 font-medium text-slate-200">
                                            <a href="{{ route('neuro_invoices.show', $invoice->id) }}" class="hover:text-cyan-400 transition-colors mono-text">{{ $invoice->invoice_number }}</a>
                                        </td>
            ...
            @if($customers->isNotEmpty())
                <div class="bg-slate-900 border border-slate-800 rounded-xl p-5 space-y-4">
                    <div class="flex items-center justify-between border-b border-slate-800 pb-3">
                        ...
                        <a href="{{ route('neuro_customers.index') }}" class="text-xs text-cyan-400 hover:text-cyan-300 font-semibold uppercase tracking-wider">View All</a>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-collapse text-sm">
                            <thead>
                            ...
                            <tbody class="divide-y divide-slate-800/40">
                                @foreach($customers as $customer)
                                    <tr class="hover:bg-slate-800/30 transition-colors">
                                        <td class="py-3 font-medium text-slate-200">
                                            <a href="{{ route('neuro_customers.show', $customer->id) }}" class="hover:text-cyan-400 transition-colors">{{ $customer->name }}</a>
                                        </td>
            ...
            @if($repairs->isNotEmpty())
                <div class="bg-slate-900 border border-slate-800 rounded-xl p-5 space-y-4">
                    <div class="flex items-center justify-between border-b border-slate-800 pb-3">
                        ...
                        <a href="{{ route('neuro_repairs.index') }}" class="text-xs text-cyan-400 hover:text-cyan-300 font-semibold uppercase tracking-wider">View All</a>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-collapse text-sm">
                            <thead>
                            ...
                            <tbody class="divide-y divide-slate-800/40">
                                @foreach($repairs as $repair)
                                    <tr class="hover:bg-slate-800/30 transition-colors">
                                        <td class="py-3 font-medium text-slate-200">
                                            <a href="{{ route('neuro_repairs.show', $repair->id) }}" class="hover:text-cyan-400 transition-colors mono-text">{{ $repair->repair_job_no }}</a>
                                        </td>
