...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-slate-900 border border-slate-800 rounded-xl p-6">
        <form action="{{ route('service_repairs.store') }}" method="POST" class="space-y-8">
            @csrf
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="customer_company" placeholder="e.g. CloudTech Labs" class="w-full bg-slate-950 border border-slate-800 text-slate-200 rounded-lg px-3 py-2 text-xs focus:outline-none focus:border-cyan-500 transition-colors">
                    </div>
            ...
            <div class="flex justify-end gap-3 border-t border-slate-800 pt-4">
                <a href="{{ route('service_repairs.index') }}" class="px-4 py-2 bg-slate-850 hover:bg-slate-800 text-slate-300 font-bold rounded-lg text-xs transition-colors">
                    CANCEL
                </a>
