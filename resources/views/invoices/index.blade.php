...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex flex-wrap gap-2 items-center">
            ...
            <a href="{{ route('invoices.create') }}" class="px-3.5 py-2 bg-cyan-500 text-slate-950 font-bold rounded-lg text-xs transition-all hover:bg-cyan-400 shadow-neon-cyan hover:shadow-neon-cyan-lg flex items-center gap-1.5">
    ...
    <div class="bg-slate-900 border border-slate-800 rounded-xl p-4">
        <form action="{{ route('invoices.index') }}" method="GET" class="flex flex-col gap-4">
                        ...
                        <tr class="hover:bg-slate-800/10 transition-colors">
                            ...
                            <td class="py-3.5 px-6 text-center">
                                <div class="flex items-center justify-center gap-1.5">
                                    <a href="{{ route('invoices.show', $inv->id) }}" class="p-1.5 bg-slate-850 hover:bg-slate-800 text-slate-300 rounded hover:text-cyan-400 transition-all" title="View details">
                                        <i class="fa-solid fa-eye"></i>
                                    </a>
                                    <a href="{{ route('invoices.print', $inv->id) }}" target="_blank" class="p-1.5 bg-slate-850 hover:bg-slate-800 text-slate-300 rounded hover:text-cyan-400 transition-all" title="Print Invoice">
                                        <i class="fa-solid fa-print"></i>
                                    </a>
                                    <a href="{{ route('invoices.print', $inv->id) }}?download=1" target="_blank" class="p-1.5 bg-slate-850 hover:bg-slate-800 text-slate-300 rounded hover:text-cyan-400 transition-all" title="Download PDF">
                                        <i class="fa-solid fa-file-pdf"></i>
                                    </a>
                                    <a href="{{ route('invoices.edit', $inv->id) }}" class="p-1.5 bg-slate-850 hover:bg-slate-800 text-slate-300 rounded hover:text-cyan-400 transition-all" title="Edit">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>

                                    @php
                                        $emailSubject = rawurlencode("Invoice #" . $inv->invoice_number . " - CLOUDTECH");
                                        $emailBody = rawurlencode("Hi,\n\nPlease find your invoice #" . $inv->invoice_number . " details here: " . route('invoices.show', $inv->id) . "\n\nThank you for choosing CLOUDTECH Computer Store!");
                                        
                                        $whatsappText = rawurlencode("Hi, please find your invoice #" . $inv->invoice_number . " details here: " . route('invoices.show', $inv->id));
                                    @endphp
                                    ...
                                    <form action="{{ route('invoices.destroy', $inv->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this invoice?')" class="inline">
                                        @csrf
                                        @method('DELETE')
